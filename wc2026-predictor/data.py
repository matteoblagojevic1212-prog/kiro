# -*- coding: utf-8 -*-
"""
World Cup 2026 data: the real 48 qualified teams, the official 12 groups,
flags (ISO codes), Elo priors and per-team scoring profiles.

Team strength is refined at runtime from real historical results (see
ratings.py); the Elo values here are only starting priors.
"""

TEAMS = {
    # ---- Group A ----
    "Mexico":      {"iso": "mx", "elo": 1810, "players": [("Santiago Gimenez", 5, 1), ("Raul Jimenez", 4, 2), ("Hirving Lozano", 3, 3), ("Alexis Vega", 2, 3), ("Edson Alvarez", 1, 2)]},
    "South Africa":{"iso": "za", "elo": 1680, "players": [("Lyle Foster", 4, 2), ("Percy Tau", 3, 3), ("Themba Zwane", 2, 3), ("Evidence Makgopa", 3, 1), ("Teboho Mokoena", 2, 3)]},
    ...
    "Czechia":     {"iso": "cz", "elo": 1740, "players": [("Patrik Schick", 5, 1), ("Adam Hlozek", 3, 3), ("Tomas Soucek", 2, 2), ("Antonin Barak", 2, 3), ("Vladimir Coufal", 1, 2)]},
    ...
    "Bosnia and Herzegovina": {"iso": "ba", "elo": 1710, "players": [("Edin Dzeko", 4, 2), ("Ermedin Demirovic", 3, 2), ("Smail Prevljak", 2, 1), ("Miralem Pjanic", 1, 4), ("Amar Dedic", 1, 3)]},
    ...
    "Haiti":       {"iso": "ht", "elo": 1500, "players": [("Frantzdy Pierrot", 4, 1), ("Duckens Nazon", 3, 1), ("Danley Jean Jacques", 2, 2), ("Derrick Etienne", 2, 3), ("Carl Sainte", 1, 2)]},
    "Scotland":    {"iso": "gb-sct", "elo": 1720, "players": [("Che Adams", 3, 2), ("John McGinn", 3, 3), ("Scott McTominay", 3, 2), ("Ryan Christie", 2, 3), ("Andy Robertson", 1, 3)]},
    ...
    "Curacao":     {"iso": "cw", "elo": 1500, "players": [("Leandro Bacuna", 3, 2), ("Tahith Chong", 2, 3), ("Juninho Bacuna", 2, 2), ("Gervane Kastaneer", 3, 1), ("Kenji Gorre", 2, 2)]},
    ...
    "Sweden":      {"iso": "se", "elo": 1780, "players": [("Alexander Isak", 5, 2), ("Viktor Gyokeres", 4, 1), ("Dejan Kulusevski", 3, 4), ("Emil Forsberg", 2, 4), ("Anthony Elanga", 2, 3)]},
    "Tunisia":     {"iso": "tn", "elo": 1710, "players": [("Youssef Msakni", 3, 3), ("Wahbi Khazri", 3, 2), ("Naim Sliti", 2, 3), ("Hannibal Mejbri", 2, 3), ("Mohamed Drager", 1, 2)]},
    ...
    # ---- Group H ----
    "Spain":       {"iso": "es", "elo": 2090, "players": [("Lamine Yamal", 4, 5), ("Nico Williams", 4, 4), ("Alvaro Morata", 4, 1), ("Dani Olmo", 3, 3), ("Pedri", 2, 3)]},
    "Cape Verde":  {"iso": "cv", "elo": 1610, "players": [("Ryan Mendes", 3, 3), ("Garry Rodrigues", 3, 3), ("Jamiro Monteiro", 2, 3), ("Bebe", 2, 2), ("Gilson Benchimol", 3, 1)]},
    "Saudi Arabia":{"iso": "sa", "elo": 1670, "players": [("Salem Al-Dawsari", 4, 3), ("Firas Al-Buraikan", 4, 1), ("Saleh Al-Shehri", 3, 1), ("Abdullah Al-Hamdan", 2, 2), ("Mohamed Kanno", 1, 2)]},
    ...
    "Iraq":        {"iso": "iq", "elo": 1620, "players": [("Aymen Hussein", 4, 1), ("Mohanad Ali", 4, 2), ("Ali Jasim", 2, 3), ("Amir Al-Ammari", 2, 3), ("Zidane Iqbal", 2, 3)]},
    ...
    # ---- Group J ----
    "Argentina":   {"iso": "ar", "elo": 2120, "players": [("Lionel Messi", 5, 5), ("Lautaro Martinez", 5, 1), ("Julian Alvarez", 4, 3), ("Angel Di Maria", 2, 4), ("Enzo Fernandez", 2, 3)]},
    ...
    "DR Congo":    {"iso": "cd", "elo": 1700, "players": [("Cedric Bakambu", 4, 1), ("Yoane Wissa", 4, 2), ("Silas Katompa", 3, 3), ("Theo Bongonda", 2, 3), ("Chancel Mbemba", 1, 1)]},
    ...
    "Croatia":     {"iso": "hr", "elo": 1880, "players": [("Andrej Kramaric", 4, 2), ("Bruno Petkovic", 3, 1), ("Luka Modric", 2, 4), ("Ivan Perisic", 3, 3), ("Mateo Kovacic", 1, 3)]},
    ...
    "Panama":      {"iso": "pa", "elo": 1680, "players": [("Cecilio Waterman", 3, 1), ("Jose Fajardo", 3, 1), ("Ismael Diaz", 3, 3), ("Adalberto Carrasquilla", 2, 3), ("Eric Davis", 1, 3)]},
}



# ---------------------------------------------------------------------------
# OFFICIAL GROUPS (12 groups A-L, 4 teams each = 48)
# ---------------------------------------------------------------------------
GROUPS = {
...
# Display names that differ from the internal key.
DISPLAY = {
    "Turkey": "Türkiye",
    "Curacao": "Curaçao",
